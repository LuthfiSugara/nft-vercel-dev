...
import { updateUserStakedBalance, updateUserBalance } from '@app/store/actions'
import { stakeFarm } from '@app/utils/calls'
import BigNumber from 'bignumber.js'
import { DEFAULT_TOKEN_DECIMAL, DEFAULT_GAS_LIMIT } from '@app/config'
import { BIG_TEN } from '@app/utils/bigNumber'
import { useMasterchef, useSousChef } from '@app/hooks/useContract'
