  ...
  return (
    <Box p={'0.5vw'}>
      <SimpleGrid columns={3} bgColor={'gicv.secondary'} p={'3vw'}>
        ...
        <Center>
          <ChakraImage
            ...
            borderRadius={'0.7vw'}
            boxSize={'25vw'}
            src={'/images/Collectible/nftsale.png'}
            alt=""
          />
        </Center>
          ...
          <VStack align={'left'} spacing={'0.7vw'}>
            ...
            <HStack spacing={'0.5vw'}>
              <ChakraImage
                ...
                borderRadius="full"
                src={'/images/Collectible/astronot2.png'}
                alt=""
              />
      ...
      <SimpleGrid columns={2} pt={'3vw'} px={'5vw'} spacing={'5vw'}>
        ...
        <Box w={'100%'} border={'0.12vw solid'} borderColor={'gicv.gray.100'} borderRadius="xl">
                  ...
                  <TabPanel>
                    <Stack spacing="14px">
                      <Flex>
                        ...
                        <Spacer />
                        <Text color={'gicv.primary'}>0xjj23bjbf23jhhjh..</Text>
                      </Flex>
                      <Flex>
                        <Text>Token ID</Text>
                        <Spacer />
                      ...
                      <Center>
                        <Text textAlign="center" color={'gicv.primary'}>
                          Request an update
                        </Text>
                      </Center>
                    </Stack>
                  ...
                  <GridItem w="150%">
                    <HStack>
                      <Box width="50px" h="50px">
                        <Image src="/images/Collectible/nftsale.png" alt="" w="100%" />
                      </Box>
                      <Box>
                        <HStack>
                          ...
                          <Image
                            borderRadius="full"
                            boxSize="10px"
                            src="/images/Collectible/check1.png"
                            alt="Dan Abramov"
                          />
                        </HStack>
                        <Text fontSize="12px" fontWeight="bold">
          ...
          <AccordionItem border={'none'}>
            ...
            <AccordionPanel p={'1.5vw'} fontSize={'1vw'}>
              <HStack spacing={'1.2vw'} overflowX={'scroll'} mt={'2vw'} pb={'3vw'} sx={withCustomScrollBar()}>
                {[...Array(15)].map((_, idx) => (
                  <Box boxShadow={'base'} borderRadius={'xl'} key={idx}>
                    <Box w="100%">
                      <Image src="/images/Collectible/nftsale.png" alt="nft" w={'100%'} borderTopRadius="xl" />
                    </Box>
                    <Stack p={4} spacing="8px" w={'200px'}>
                      ...
                      <HStack>
                        <Image src="/images/Collectible/astronot2.png" alt="" borderRadius={'2xl'} boxSize="20px" />
                        <Text fontSize="xs" as="b" color={'#FF6600'}>
                          Astrologizer Punk
                        </Text>
                      </HStack>

                      <Stack>
                        <Text fontSize="11px" as="b" mt={5} color="#6C757D">
                          Buy Now
                        </Text>
                        <HStack>
