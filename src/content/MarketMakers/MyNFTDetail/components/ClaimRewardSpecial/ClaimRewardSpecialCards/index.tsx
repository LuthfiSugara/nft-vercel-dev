...
import CardActions from '@app/content/MarketMakers/MyNFTDetail/components/ClaimRewardSpecial/ClaimRewardSpecialCards/ClaimRewardSpecialCard/CardActions'

const ClaimRewardSpecialCards = ({ displayClaimRewardSpecial, idnft, batchid, year, account }) => {
  const months = ['', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
  return (
    <SimpleGrid columns={[2, 2, 6]} spacing={['3vw', '3vw', '1vw']}>
      {displayClaimRewardSpecial.map((_, i) => {
        return (
          <Box
            key={i}
            bg={'legion.white'}
...
export default ClaimRewardSpecialCards
