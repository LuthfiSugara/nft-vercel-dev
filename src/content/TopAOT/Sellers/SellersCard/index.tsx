...
const SellersCard: FC<ISellersCard> = ({ rank, img, name, nftsSold, totalSales }) => {
  return (
    <Grid
    ...
    >
      ...
      <GridItem colSpan={3}>
        <Box textAlign={'right'} h={'full'} alignItems={'center'}>
          <Balance value={totalSales} decimals={0} unit={' WGICT'} />
          <Balance
            value={totalSales * 0.95}
            decimals={0}
            prefix={'$'}
            fontSize={'0.85vw'}
            fontWeight={'bold'}
