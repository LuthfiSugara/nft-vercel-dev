...
import TopBuyersCard from '@app/components/TopBuyersCard'
...
const TopBuyer: React.FunctionComponent<ITopBuyerProps> = ({ listNumber }) => {
  return (
    <Box
      bgImage={
    ...
    >
      ...
      >
        ...
        <GridItem colSpan={12} py={'1.3vw'}>
          ...
          >
            {[...Array(12)].map((_, idx) => (
              <TopBuyersCard key={`top_buyers_card_item__${idx}`} />
            ))}
          </HStack>
        </GridItem>
      </Grid>
