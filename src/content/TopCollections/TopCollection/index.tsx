...
import TopCollectionsCard from '@app/components/TopCollectionsCard'
...
const TopCollection: React.FunctionComponent<ITopCollectionProps> = ({ listNumber }) => {
  return (
    <Box
      bgImage={
    ...
    >
      ...
      >
        ...
        <GridItem colSpan={7} py={'3.7vw'}>
          ...
          >
            ...
            <SimpleGrid columns={2}>
              ...
              <Balance value={221.56} decimals={2} prefix={': $'} fontSize={'1vw'} fontWeight={'extrabold'} />
            </SimpleGrid>
          </Flex>
        </GridItem>
        <GridItem colSpan={12} py={'1.3vw'}>
          ...
          >
            {[...Array(12)].map((_, idx) => (
              <TopCollectionsCard key={`top_collections_card_item__${idx}`} />
            ))}
          </HStack>
        </GridItem>
      </Grid>
