import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@aulyaaryansyah/legionswap-sdk-mainnet'
import { useMemo } from 'react'
import useActiveWeb3React from '@app/hooks/useActiveWeb3React'
import { BIPS_BASE, INITIAL_ALLOWED_SLIPPAGE } from '@app/config/constants'
import { useTransactionAdder } from '@app/store/transactions/hooks'
import { calculateGasMargin, getRouterContract, isAddress } from '@app/utils'
 ...
 * @param  trade to execute
 * @param  user allowed slippage
 */
  ...
  return useMemo(() => {
    ...
    return {
      ...
      callback: async function onSwap(): Promise<string> {
        ...
        const successfulEstimation: SuccessfulCall = estimatedCalls.find(
