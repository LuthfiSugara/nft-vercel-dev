...
import { getMasterchefContract } from '@app/utils/contractHelpers'
import { getAddress } from '@app/utils/addressHelpers'
import { simpleRpcProvider } from '@app/utils/providers'
import BigNumber from 'bignumber.js'

// Pool 0, Legion / Legion is a different kind of contract (master chef)
...
export const fetchUserPendingRewards = async (account) => {
  ...
  // Legion / Legion pool
  const pendingReward = await masterChefContract.pendingLgn('0', account)
