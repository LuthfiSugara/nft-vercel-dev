import { ONE_DAY_UNIX, PCS_V2_START } from '@app/config/constants/info'
import { getUnixTime } from 'date-fns'
import { TransactionType } from '@app/store/info/types'
import { ChartEntry } from '../types'
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, LegionDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | LegionDayData): ChartEntry => ({
