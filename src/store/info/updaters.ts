...
import useFetchProtocolData from '@app/store/info/queries/protocol/overview'
import useFetchGlobalChartData from '@app/store/info/queries/protocol/chart'
import fetchTopTransactions from '@app/store/info/queries/protocol/transactions'
import useTopPoolAddresses from '@app/store/info/queries/pools/topPools'
import usePoolDatas from '@app/store/info/queries/pools/poolData'
import useFetchedTokenDatas from '@app/store/info/queries/tokens/tokenData'
import useTopTokenAddresses from '@app/store/info/queries/tokens/topTokens'
import {
  useProtocolData,
