...
import {
  ...
  DeserializedMarketMakerConfig,
  SerializedPoolConfig,
  SerializedMarketMakerConfig,
  Team,
  TranslatableText,
...
export interface DeserializedMarketMaker extends DeserializedMarketMakerConfig {
  userData?: {
    allowance: BigNumber
  }
}
...
export interface SerializedMarketMaker extends SerializedMarketMakerConfig {
  userData?: {
    allowance: SerializedBigNumber
  }
}
...
export interface MarketMakersState {
  data: SerializedMarketMaker[]
  userDataLoaded: boolean
}
...
export interface State {
  ...
  pools: PoolsState
  marketMakers: MarketMakersState
