...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@aulyaaryansyah/legionswap-sdk-mainnet'
...
export function getRouterContract(_: number, library: Web3Provider, account?: string): Contract {
  return getContract(ROUTER_ADDRESS, UniswapAbi, library, account)
}
